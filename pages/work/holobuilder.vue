    ...
    <div class="template-container-inner pa3 pa5-ns tc">
      <div class="on-top">
        ...
        <project-summary title="HoloBuilder">
          <a href="https://www.holobuilder.com/">HoloBuilder</a> is an augmented and virtual reality platform
...
export default {
  ...
  data: () => ({
    process: {
      ...
      roles: ["VP of Customer &amp; Data Analytics &amp; Optimization", "Strategy", "User Research", "Interaction Design"],
      process: {
        "Discovery": ["literature review", "competitive analysis"],
        "Floor Plan Feature": ["sketches", "storyboards", "wireframes"],
        "Data Analytics": ["1st high-fidelity prototype", "crowd worker experiments", "user study"]
      }
    }
  })
}
